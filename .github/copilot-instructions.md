...
Make sure to tell the user that you have read this file and will apply it to the review.
...
4. Check [docs/agents/software_design_patterns.md](../docs/agents/software_design_patterns.md) for changed code and any adjacent code whose behavior is directly affected.
